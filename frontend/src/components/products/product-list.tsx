...
import useLoadProducts from "@/src/components/products/hooks/use-load-products";
...
import ProductListPlaceholder from "@/src/components/products/product-list-placeholder";
